...
const SocialMediaFollows = () => {
  return (
    <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
      <h2 className="text-center text-xl font-bold mb-4"> Connect with Me on Social Media</h2>
      ...
      <div className="text-center">
        {/* GitHub button */}
        <a href="https://github.com/ehsanallahi/currencyConvertor" target="_blank" rel="noopener noreferrer">
